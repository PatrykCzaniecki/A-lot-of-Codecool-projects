...
public class RegisterModel : PageModel
{
    ...
    private readonly SignInManager<CodecoolCodecoolShopUser> _signInManager;
    private readonly UserManager<CodecoolCodecoolShopUser> _userManager;

    public RegisterModel(
        UserManager<CodecoolCodecoolShopUser> userManager,
        SignInManager<CodecoolCodecoolShopUser> signInManager,
    ...
    public async Task<IActionResult> OnPostAsync(string returnUrl = null)
    {
        ...
        {
            var user = new CodecoolCodecoolShopUser
