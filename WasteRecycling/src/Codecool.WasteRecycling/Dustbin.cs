...
public class Dustbin
{
    ...
    public DynamicArray GarbageBin { get; }
    ...
    public void ThrowOutGarbage(Garbage garbage)
    {
        ...
        {
            var paperGarbage = (PaperGarbage) garbage;
            if (!paperGarbage.Squeezed) throw new DustbinContentException();
        }

        if (garbage is PlasticGarbage)
        {
            var plasticGarbage = (PlasticGarbage) garbage;
            if (!plasticGarbage.Cleaned) throw new DustbinContentException();
        }
    ...
    {
        var houseWasteContent = "";
        var paperWasteContent = "";
        var plasticWasteContent = "";
        var houseWasteCount = 0;
        var paperWasteCount = 0;
        var plasticWasteCount = 0;
